...
public class ObjectCollision : MonoBehaviour
{
    ...
    public TextMeshProUGUI countText; // Reference to the count display UI
    public TextMeshProUGUI gameOverText; // Reference to the Game Over display UI
    public TextMeshProUGUI messageText; // Reference to the message display UI
    public GameObject player; // Reference to the player GameObject
    public List<int> fixedList = new List<int>();
    public List<int> countList = new List<int>();
    public GameObject teleportobject2;
    ...
    void Start()
    {
        // Disable the Game Over text and message text at the start
        if (gameOverText != null)
        {
            gameOverText.enabled = false;
        }
    ...
    void CompareLists()
    {
        if (fixedList == null)
        {
            Debug.Log("Fixed list is null. Resetting the game and teleporting player.");
            StartCoroutine(DisplayMessage("Fixed list is null. Teleporting and resetting game...", 6));
            ResetGame();
            return;
        }
    ...
    {
        // Game reset logic
        Debug.Log("Game reset due to mismatch or null fixed list. Restarting level...");
        UnityEngine.SceneManagement.SceneManager.LoadScene(UnityEngine.SceneManagement.SceneManager.GetActiveScene().name);
    }
    ...
    // Coroutine to display a message for a specified duration
